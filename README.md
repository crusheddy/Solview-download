...
The application source lives in the private `solview` repository. Nothing in
...
```
https://crusheddy.github.io/Solview-download/
```
...
```bash
gh release create v0.1.0 ./solview-v0.1.0.apk --notes "First build"
```
